...
foreach (@ARGV) {
    ...
    open (FH, "/home/menglingshan/buildroot-2015.11_normal/output/host/usr/bin/aarch64-marvell-linux-gnu-cpp -DHAVE_CONFIG_H -DVTYSH_EXTRACT_PL -DHAVE_IPV6 -I.. -I./ -I./.. -I../lib -I../lib -I../isisd/topology -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 $file |");
    local $/; undef $/;
    $line = <FH>;
    close (FH);
